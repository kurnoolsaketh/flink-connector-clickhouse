...
3. Tag the version update commit as `v<version_number>` (e.g. v0.1.3 for version 0.1.3) and push the tag to origin. **This will automatically trigger a Github action that will PR an update to all version references in the project and create a Github release for the new version.**
```bash
